...
class ViT(nn.Module):
    def __init__(self, *, image_size=15, patch_size=3, num_classes=16, dim=64, depth=6, heads=8, mlp_dim=128, pool = 'cls', channels =120, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
...
class MyNet(nn.Module):
    def __init__(self, in_channels=1, num_classes=NUM_CLASS, num_tokens=4, dim=120, depth=1, heads=8, mlp_dim=240,
        ...
        self.Avg = nn.AvgPool2d(kernel_size=(13, 13))
